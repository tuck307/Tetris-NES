...
<body onload="load();">
    ...
    <div id="options">
      <div class="checkbox">
        <label>
          <input type="checkbox"> Pause Game
        </label>
      </div>
      <div class="checkbox">
        <label>
...
//        var row = document.getElementById('game').children[21];
